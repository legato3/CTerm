...
private let logger = Logger(subsystem: "com.legato3.cterm", category: "GhosttyApp")
...
private func ghosttyReadClipboardCallback(
    ...
    MainActor.assumeIsolated {
        ...
        case GHOSTTY_CLIPBOARD_SELECTION:
            ...
            pasteboard = .init(name: .init("com.cterm.selection"))
        default:
            pasteboard = .general
        }
...
extension Notification.Name {
    static let ghosttyCloseSurface = Notification.Name("com.cterm.ghostty.closeSurface")
    static let ghosttyNewWindow = Notification.Name("com.cterm.ghostty.newWindow")
    static let ghosttyNewTab = Notification.Name("com.cterm.ghostty.newTab")
    static let ghosttyNewSplit = Notification.Name("com.cterm.ghostty.newSplit")
    static let ghosttyCloseTab = Notification.Name("com.cterm.ghostty.closeTab")
    static let ghosttyCloseWindow = Notification.Name("com.cterm.ghostty.closeWindow")
    static let ghosttySetTitle = Notification.Name("com.cterm.ghostty.setTitle")
    static let ghosttySetPwd = Notification.Name("com.cterm.ghostty.setPwd")
    static let ghosttyCellSizeChange = Notification.Name("com.cterm.ghostty.cellSizeChange")
    static let ghosttyInitialSize = Notification.Name("com.cterm.ghostty.initialSize")
    static let ghosttySizeLimit = Notification.Name("com.cterm.ghostty.sizeLimit")
    static let ghosttyConfigChange = Notification.Name("com.cterm.ghostty.configChange")
    static let ghosttyColorChange = Notification.Name("com.cterm.ghostty.colorChange")
    static let ghosttyToggleFullscreen = Notification.Name("com.cterm.ghostty.toggleFullscreen")
    static let ghosttyRendererHealth = Notification.Name("com.cterm.ghostty.rendererHealth")
    static let ghosttyRingBell = Notification.Name("com.cterm.ghostty.ringBell")
    static let ghosttyShowChildExited = Notification.Name("com.cterm.ghostty.showChildExited")
    static let ghosttyCommandFinished = Notification.Name("com.cterm.ghostty.commandFinished")
    static let ghosttyGotoSplit = Notification.Name("com.cterm.ghostty.gotoSplit")
    static let ghosttyResizeSplit = Notification.Name("com.cterm.ghostty.resizeSplit")
    static let ghosttyEqualizeSplits = Notification.Name("com.cterm.ghostty.equalizeSplits")
    static let ghosttyDesktopNotification = Notification.Name("com.cterm.ghostty.desktopNotification")
    static let ghosttyStartSearch = Notification.Name("com.cterm.ghostty.startSearch")
    static let ghosttyEndSearch = Notification.Name("com.cterm.ghostty.endSearch")
    static let ghosttySearchTotal = Notification.Name("com.cterm.ghostty.searchTotal")
    static let ghosttySearchSelected = Notification.Name("com.cterm.ghostty.searchSelected")
    static let ghosttyGotoTab = Notification.Name("com.cterm.ghostty.gotoTab")
    static let glassOpacityDidChange = Notification.Name("com.cterm.glassOpacityDidChange")
    static let ghosttyConfirmClipboard = Notification.Name("com.cterm.ghostty.confirmClipboard")
    // IPC / Agent GUI
    static let ctermIPCEnable = Notification.Name("com.cterm.ipc.enable")
    static let ctermIPCDisable = Notification.Name("com.cterm.ipc.disable")
    /// userInfo: ["roleNames": [String], "autoStart": Bool, "sessionName": String, "initialTask": String]
    static let ctermIPCLaunchWorkflow = Notification.Name("com.cterm.ipc.launchWorkflow")
