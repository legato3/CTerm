...
private let logger = Logger(subsystem: "com.legato3.cterm", category: "GhosttyAction")
...
enum GhosttyActionRouter {
    ...
    private static func handleToggleCommandPalette(
        ...
        guard let wc = NSApp.keyWindow?.windowController as? CTermWindowController else { return false }
