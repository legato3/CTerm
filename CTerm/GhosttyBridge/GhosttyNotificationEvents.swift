...
struct CTermIPCLaunchWorkflowEvent {
    let roleNames: [String]
    let autoStart: Bool
    let sessionName: String
    let initialTask: String
    let workingDirectory: String?
    let skipDirectoryPrompt: Bool
    ...
    static func from(_ notification: Notification) -> Self? {
        ...
        return CTermIPCLaunchWorkflowEvent(
            roleNames: roleNames,
            ...
            workingDirectory: (notification.userInfo?["workingDirectory"] as? String)?
                .trimmingCharacters(in: .whitespacesAndNewlines),
            skipDirectoryPrompt: (notification.userInfo?["skipDirectoryPrompt"] as? Bool) ?? false,
