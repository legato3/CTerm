...
// CTerm
//
// Persists user-saved prompts to ~/.cterm/prompts.json.
...
/// Manages the user's saved prompt library, persisted to ~/.cterm/prompts.json.
@MainActor
enum PromptLibraryManager {

    private static let promptsURL: URL =
        URL(fileURLWithPath: NSHomeDirectory())
            .appendingPathComponent(".cterm/prompts.json")
