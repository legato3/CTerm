...
// ~/.cterm/triggers.json and evaluated whenever a trigger event fires.
//
...
private let logger = Logger(subsystem: "com.legato3.cterm", category: "TriggerEngine")
...
extension Notification.Name {
    static let shellErrorCaptured = Notification.Name("com.legato3.cterm.shellErrorCaptured")
    static let peerRegistered     = Notification.Name("com.legato3.cterm.peerRegistered")
}
