...
final class TabReorderUITests: CTermUITestCase {
    ...
    private func tabBarTabIdentifier(atIndex index: Int) -> String? {
        let value = "cterm.tabBar.tab.index.\(index)"
    ...
    /// The value pattern is "cterm.sidebar.group.<UUID>.tab.index.<N>".
    private func sidebarTabIdentifier(atIndex index: Int) -> String? {
        let pattern = "cterm.sidebar.group.*.tab.index.\(index)"
    ...
    func test_dragTabBarTab_reordersCorrectly() {
        ...
        let firstTabValue = "cterm.tabBar.tab.index.0"
        ...
        let thirdTabValue = "cterm.tabBar.tab.index.2"
    ...
    func test_dragSidebarTab_reordersCorrectly() {
        ...
        let firstSidebarPattern = "cterm.sidebar.group.*.tab.index.0"
        ...
        let thirdSidebarPattern = "cterm.sidebar.group.*.tab.index.2"
