...
final class TabRenameUITests: CTermUITestCase {
    ...
    func test_renameTabByDoubleClick() {
        ...
        let tabRow = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@", "cterm.sidebar.tab."))
            .firstMatch
        XCTAssertTrue(
        ...
        let renameField = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@", "cterm.sidebar.tabNameTextField."))
            .firstMatch
        XCTAssertTrue(
    ...
    func test_renameInactiveTab() {
        ...
        let sidebarTabs = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@ AND NOT identifier CONTAINS %@", "cterm.sidebar.tab.", "closeButton"))
