...
final class BrowserUITests: CTermUITestCase {
    ...
    func test_browserToolbarVisible() {
        ...
        let toolbar = app.descendants(matching: .any)
            .matching(identifier: "cterm.browser.toolbar")
            .firstMatch
