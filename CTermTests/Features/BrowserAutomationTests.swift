...
final class BrowserAutomationTests: XCTestCase {
    ...
    func test_snapshot_stamps_data_cterm_ref() {
        let js = BrowserAutomation.snapshot()
        XCTAssertTrue(js.contains("data-cterm-ref"),
                      "snapshot JS should stamp data-cterm-ref attributes")
    }
    ...
    func test_click_with_ref_selector() {
        ...
        XCTAssertTrue(js.contains("data-cterm-ref"),
                      "click with @ref should resolve to data-cterm-ref selector")
    ...
    func test_clearRefs_removes_data_cterm_ref() {
        let js = BrowserAutomation.clearRefs()
        XCTAssertTrue(js.contains("data-cterm-ref"),
                      "clearRefs JS should reference data-cterm-ref attributes")
    }
