...
private let logger = Logger(subsystem: "com.legato3.terminal", category: "TerminalSearchIndex")
...
final class TerminalSearchIndex: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.legato3.terminal.search-index", qos: .utility)
