...
// Persisted to ~/.calyx/sessions/{date}-{sessionID}.json on every append.
...
private let logger = Logger(subsystem: "com.legato3.terminal", category: "SessionAuditLogger")
...
final class SessionAuditLogger {
    ...
    private init() {
        let sessionsDir = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".calyx/sessions")
