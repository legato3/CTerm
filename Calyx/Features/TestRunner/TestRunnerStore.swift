...
private let logger = Logger(subsystem: "com.legato3.terminal", category: "TestRunnerStore")
...
extension Notification.Name {
    static let testRunnerFinished = Notification.Name("com.legato3.terminal.testRunnerFinished")
}
