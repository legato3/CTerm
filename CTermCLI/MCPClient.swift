...
//  CTermCLI
//
//  HTTP client that communicates directly with CTerm BrowserServer.
//
...
enum CLIError: Error, CustomStringConvertible {
    ...
    var description: String {
        switch self {
        case .notRunning:
            return "CTerm is not running. Start CTerm first."
        case .invalidStateFile:
            return "Invalid state file at ~/.config/cterm/browser.json"
